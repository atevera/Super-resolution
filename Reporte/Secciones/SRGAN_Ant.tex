...
reales de las observaciones utilizadas durante el aprendizaje. Cuanto menor es el resultado de esta función, 
...
En el caso de las redes adversarias, específicamente en \emph{SRGAN} como mencionan Goodfellow et al. \cite{GANs}, se tienen 
2 perdidas principales: Las de contenido (\emph{content loss}) definidas por las  las cuales son 
