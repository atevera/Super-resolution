...
Maxpooling (Valores máximos de los parches)  y 1 capa de SoftMax como se observa en la imagen \ref{Alexis35}. El modelos se construyo
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[scale = 0.7]{VGG19.jpg}
